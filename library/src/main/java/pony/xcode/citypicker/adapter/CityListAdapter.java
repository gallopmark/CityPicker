...
import pony.xcode.citypicker.adapter.decoration.GridItemDecoration;
...
public class CityListAdapter extends RecyclerView.Adapter<CityListAdapter.BaseViewHolder> {
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int position) {
        ...
        if (holder instanceof LocationViewHolder) {
            ...
            int itemWidth = (screenWidth - padding - space * (mGridSpanCount - 1) - indexBarWidth) / mGridSpanCount;
    ...
    public class HotViewHolder extends BaseViewHolder {
        ...
        HotViewHolder(View itemView) {
            ...
            mRecyclerView.setLayoutManager(new GridLayoutManager(itemView.getContext(),
                    mGridSpanCount, LinearLayoutManager.VERTICAL, false));
            int space = itemView.getContext().getResources().getDimensionPixelSize(R.dimen.cp_grid_item_space);
            mRecyclerView.addItemDecoration(new GridItemDecoration(mGridSpanCount, space));
        }
    }
